...
const data = {
  ...
  Hair: [{ id: "hair-pic1", src: require("../assets/hair-pic1.png") }],
  Hats: [
        ...
        <View style={styles.middleContainer}>
          ...
          {this.state.faces.map(face => (
            <Filter
              ...
              face={face}
              source={filters[this.state.currentFilter].src}
              width={filters[this.state.currentFilter].width}
              height={filters[this.state.currentFilter].height}
              left={filters[this.state.currentFilter].left}
              right={filters[this.state.currentFilter].right}
              top={filters[this.state.currentFilter].top}
            />
          ))}
        </View>
              ...
              {Object.keys(data).map(category => (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderWidth: 2,
                    backgroundColor: this.state.selected === category ? "#FFA384" : "#E7F2F8"
                    }}
                  onPress={() =>
                    this.setState({
                      selected: category,
                  ...
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      marginBottom: RFValue(10),
                        borderColor: this.state.currentFilter === filter_data.id ? "#FFA384" : "#FFFF"
                      }}
                    onPress={() =>
                      this.setState({
                        currentFilter: `${filter_data.id}`
                      })
                    }
                  >
                    <Image
